    ...
    return (
      <PostWrapper>
        ...
        <p>
          ...
          those functions to the home component so they know to reference Home when I call the function in other components.
        </p>
        <p>
        ...
        <p>
          ...
          out the && for a question mark, and adding a colon between the two things you like to render. If the first evaluation passes it will render the first button, If not it
          will render the second button.
        </p>
        <div>
